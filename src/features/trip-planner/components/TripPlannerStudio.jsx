...
import SavedItineraryList from './saved/SavedItineraryList';
import TripInputPanel from './TripInputPanel';
import ItineraryDayViewer from './ItineraryDayViewer';
...
export default function TripPlannerStudio({ prefill, initialTab }) {
  ...
  const renderItineraryContent = () => (
    <ItineraryDayViewer
      ...
      language={language}
      setActivePlannerTab={setActivePlannerTab}
      setSelectedSpot={setSelectedSpot}
      isNavigating={isNavigating}
      simDistance={simDistance}
      simDuration={simDuration}
      simActiveStreet={simActiveStreet}
      ...
      setShowTravelRoute={setShowTravelRoute}
      isSavedItinerary={isSavedItinerary}
      activeItineraryId={activeItineraryId}
      activeItineraryStatus={activeItineraryStatus}
      handleCompleteItinerary={handleCompleteItinerary}
      isMobileDevice={isMobileDevice}
      mobileViewMode={mobileViewMode}
      selectSpotAndScroll={selectSpotAndScroll}
      formatPriceRange={formatPriceRange}
      handleSwapSpot={handleSwapSpot}
      slotPage={slotPage}
      ...
      allDbSpots={allDbSpots}
      rentalPage={rentalPage}
      setRentalPage={setRentalPage}
      style={style}
      setMobileViewMode={setMobileViewMode}
    />
  );
  // TODO: Remove oldRenderItineraryContent after verifying the new component works
  const oldRenderItineraryContent = () => {
    if (!itinerary) {
      if (selectedSpot) {
        return (
    ...
    <div className="max-w-[95%] w-full mx-auto px-6 py-10 flex flex-col items-center gap-10">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            {!loading && !itinerary && (
              <div className="w-full h-[550px] border border-dashed border-gray-250 bg-gradient-to-br from-white to-gray-50/30 rounded-3xl flex flex-col items-center justify-center text-center p-8 gap-5 animate-fade-in relative overflow-hidden shadow-inner">
                ...
                <div className="bg-white border border-gray-250/60 p-5 rounded-full text-heritage-amber shadow-md animate-float relative z-10">
      ...
      {activePlannerTab === 'saved' && (
        <SavedItineraryList
          ...
          handleLoadSaved={handleLoadSaved}
