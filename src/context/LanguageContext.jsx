...
const translations = {
  vi: {
    ...
    tagAdventure: 'Trải nghiệm',
    tagHealing: 'Tĩnh dưỡng Healing',
    tagScenic: 'Góc chụp ảnh đẹp',
  ...
  en: {
    ...
    tagAdventure: 'Adventures',
    tagHealing: 'Wellness / Healing',
    tagScenic: 'Scenic Spots',
