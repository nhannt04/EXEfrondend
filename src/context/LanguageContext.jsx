...
const translations = {
  vi: {
    ...
    heroSubtitle: 'Nhập ngân sách, thời gian và gu của bạn. Trí tuệ nhân tạo sẽ lập tức thiết lập lịch trình ăn chơi, ngủ nghỉ tối ưu và tiết kiệm nhất.',
  ...
  en: {
    ...
    heroSubtitle: 'Enter your budget, duration, and personal style. AI will instantly craft the most optimal and cost-effective food, stay, and activities map.',
